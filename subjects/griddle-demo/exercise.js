...
render(<App getExternalResults={loadData} loadingComponent={Loading} enableSort={true} enableInfiniteScroll={true} bodyHeight={200} columns={["name", "model", "manufacturer", "passengers"]} resultsPerPage={10} showFilter={false} showSettings={false} />, document.getElementById('griddle-callback'));